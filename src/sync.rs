...
/// Position will be updated by the video's background worker thread.
...
pub fn synchronized_set_paused(video_id: usize, video: &iced_video_player::Video, paused: bool) {
